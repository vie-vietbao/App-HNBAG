...
public class SettingRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.lnlLogin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SettingRegister.this, Login.class);
        ...
        lnlEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SettingRegister.this, "Xin lỗi! Phiên bản hiện tại chưa hỗ trợ tính năng này", Toast.LENGTH_SHORT).show();
            }
        });
