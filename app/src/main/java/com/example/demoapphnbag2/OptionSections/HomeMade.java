...
import com.example.demoapphnbag2.ViewPager.ViewPagerAdapterOPSHM;
...
public class HomeMade extends AppCompatActivity {
    ...
    private ViewPagerAdapterOPSHM viewPagerAdapterOPSHM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapterOPSHM = new ViewPagerAdapterOPSHM(this);
        viewPager.setAdapter(viewPagerAdapterOPSHM);
