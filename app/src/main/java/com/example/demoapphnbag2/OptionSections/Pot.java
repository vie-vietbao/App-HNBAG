...
import com.example.demoapphnbag2.ViewPager.ViewPagerAdapterOPSPot;
...
public class Pot extends AppCompatActivity {
    ...
    private ViewPagerAdapterOPSPot viewPagerAdapterOPSPot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapterOPSPot = new ViewPagerAdapterOPSPot(this);
        viewPager.setAdapter(viewPagerAdapterOPSPot);
